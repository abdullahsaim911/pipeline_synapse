...
def download_qwen2_vl_instruct(repo_id: str, destination: str, revision: str | None, force: bool, token: str | None) -> str:
    try:
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Download Qwen2-VL-2B-Instruct into the local models folder."
    )
    parser.add_argument(
        "--repo-id",
        default="Qwen/Qwen2-VL-2B-Instruct",
        help="Hugging Face model repo id to download (default: Qwen/Qwen2-VL-2B-Instruct).",
    )
    parser.add_argument(
        "--output-dir",
        default="F:/Prototyping/Synapse/models/Qwen2-VL-2B-Instruct",
